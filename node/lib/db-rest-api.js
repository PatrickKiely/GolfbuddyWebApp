...
exports.rest = {
  ...
  create: function( req, res ) {
    ...
    golfcoll.insert(golf, res.err$(function( docs ){
  ...
  read: function( req, res ) {
    ...
    golfcoll.findOne( query, res.err$( function( doc ) {
      if( doc ) {
  ...
  list: function( req, res ) {
    ...
    golfcoll.find( query, options, res.err$( function( cursor ) {
  ...
  del: function( req, res ) {
    ...
    var query = util.fixid( {id:input.id} )
    golfcoll.remove( query, res.err$( function() {
      var output = {}
      res.sendjson$( output )
    }))
  }
...
exports.connect = function(options,callback) {
  ...
  client.open( function( err, client ) {
    ...
    client.collection( 'golf', function( err, collection ) {
      if( err ) return callback(err);
